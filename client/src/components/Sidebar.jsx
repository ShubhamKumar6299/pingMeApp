...
const Sidebar = ({sidebarOpen, setSidebarOpen}) => {
  ...
  return (
    <div className={`w-60 xl:w-72 bg-white border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z=20
        ${sidebarOpen ? 'translate-x-0' : 'max-sm:-translate-z-full'} transition-all duration-300 ease-in-out`}>
            <div className='w-full'>
                ...
                mx-6 mt-6 rounded-lg bg-linear-to-r from-indigo-500 to-purple-600
